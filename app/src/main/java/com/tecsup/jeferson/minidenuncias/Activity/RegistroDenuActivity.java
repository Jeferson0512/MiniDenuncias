...
public class RegistroDenuActivity extends AppCompatActivity {

    private static final String TAG = RegistroDenuActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_denu);
    ...
    public void callRegister(View view) {
        ...
        String titulo = nombreInput.getText().toString();
        //String precio = precioInput.getText().toString();
        String descripcion = detallesInput.getText().toString();

        if (titulo.isEmpty()) {
            Toast.makeText(this, "Titulo es un campo requerido", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createRegistro(titulo, descripcion);
        } else {
            ...
            RequestBody detallesPart = RequestBody.create(MultipartBody.FORM, descripcion);

            call = service.createRegistroWithImage(nombrePart, detallesPart, imagenPart);
        }
            ...
            public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(RegistroDenuActivity.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                        finish();
                    ...
                    try {
                        ...
                        Toast.makeText(RegistroDenuActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    } catch (Throwable x) {
                    }
                }
            }
